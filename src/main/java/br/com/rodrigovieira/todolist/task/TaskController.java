package br.com.rodrigovieira.todolist.task;
...
import br.com.rodrigovieira.todolist.utils.Utils;
...
public class TaskController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity uptade(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request){
        ...
        if(!task.getIdUser().equals(idUser)){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Usuário não te permissão para alterar essa tarefa");
        }
